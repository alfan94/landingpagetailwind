<x-app-layout>
     ...
     <div class="max-w-7xl sm:px-6 lg:px-8 pt-[30px] ">
        <div class="container">
            <div class="px-4 bg-white shadow-lg rounded-lg ">
                ...
                <a href="{{url('terbaru/create')}}"class="bg-teal-500 text-right rounded-full px-4 text-base text-white hover:bg-red-900 cursor-pointer">Create</a>
                </span>
                ...
                <table id="datables" class="min-w-full mx-auto divide-y divide-gray-200 mb-3">
                    ...
                    <tbody>
                        ...
                        <td class="border border-slate-200"><img class="h-10 w-10" src="{{asset('jefan/images/'.$terbaru->foto)}}"></td>
                        <td class="border border-slate-200 flex justify-center">
                            <a href="{{url('terbaru/edit')}}/{{$terbaru->id}}" class=" px-4 shadow-lg bg-yellow-600 rounded-full text-white hover:bg-blue-400 font-semibold">Edit</a>

                            <form action="{{url('terbaru/hapus')}}/{{$terbaru->id}}" method="post" enctype='multipart/form-data' >
                    @csrf 
                    @method('delete')
